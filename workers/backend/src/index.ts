...
import { createDynamoArticleRepository, type ArticleRepository } from "./repositories/articleRepository";
...
export type ArticleRepositoryFactory = (env: Env) => ArticleRepository;

export function createApp(createRepository: ArticleRepositoryFactory = createDynamoArticleRepository) {
  ...
  app.use("*", async (c, next) => {
    const repo = createRepository(c.env);
